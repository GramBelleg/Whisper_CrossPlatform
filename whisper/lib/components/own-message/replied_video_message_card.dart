...
class RepliedVideoMessageCard extends OwnMessage {
  final String blobName;
  final String repliedContent;
  final String repliedSenderName;

  RepliedVideoMessageCard({
  ...
  Widget build(BuildContext context) {
    return _RepliedVideoMessageCardStateful(
      blobName: blobName,
      message: message,
...
class _RepliedVideoMessageCardStateful extends StatefulWidget {
  final String blobName;
  ...
  const _RepliedVideoMessageCardStateful({
    required this.blobName,
  ...
  @override
  State<_RepliedVideoMessageCardStateful> createState() =>
      _RepliedVideoMessageCardState();
}

class _RepliedVideoMessageCardState
