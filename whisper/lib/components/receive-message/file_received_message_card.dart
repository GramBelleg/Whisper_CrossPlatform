...
class FileReceivedMessageCard extends ReceivedMessage {
  final String blobName;

  FileReceivedMessageCard({
  ...
  Widget build(BuildContext context) {
    return _FileReceivedMessageCardStateful(
      blobName: blobName,
      message: message,
...
class _FileReceivedMessageCardStateful extends StatefulWidget {
  final String blobName;
  ...
  @override
  State<_FileReceivedMessageCardStateful> createState() =>
      _FileReceivedMessageCardState();
}

class _FileReceivedMessageCardState
    extends State<_FileReceivedMessageCardStateful> {
  final Dio dio = Dio();
