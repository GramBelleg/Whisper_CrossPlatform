...
class ForwardedVideoMessageCard extends OwnMessage {
  final String blobName;
  final String forwardedSenderName;

  ForwardedVideoMessageCard({
  ...
  Widget build(BuildContext context) {
    return _ForwardedVideoMessageCardStateful(
      blobName: blobName,
      caption: message,
      message: message,
...
class _ForwardedVideoMessageCardStateful extends StatefulWidget {
  final String blobName;
  ...
  const _ForwardedVideoMessageCardStateful({
    required this.blobName,
  ...
  @override
  State<_ForwardedVideoMessageCardStateful> createState() =>
      _ForwardedVideoMessageCardState();
}

class _ForwardedVideoMessageCardState
