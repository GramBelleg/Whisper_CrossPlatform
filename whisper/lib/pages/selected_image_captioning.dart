...
class SelectedImageCaptioning extends StatefulWidget {
  ...
  const SelectedImageCaptioning(
      {required this.mediaPaths, required this.sendFile});

  @override
  SelectedImageCaptioningState createState() => SelectedImageCaptioningState();
}

class SelectedImageCaptioningState extends State<SelectedImageCaptioning> {
